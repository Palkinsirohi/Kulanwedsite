...
< h2 className="text-base font-semibold tracking-wide uppercase text-[#ffd800]">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="relative z-10 lg:w-1/2">
          ...
          <div className="mb-8 lg:mb-12">
            <button className="bg-[#ffd800] text-[#0f2d26] px-6 py-3 rounded-lg font-semibold mb-6 hover:bg-[#d4c5a0] transition-colors">
              Why Choose Kulan
            </button>
          ...
          <div className="bg-[#356e62] p-6 md:p-8 rounded-2xl shadow-lg mt-8 lg:mt-12 lg:-mr-16">
            <div className="flex items-center gap-4 md:gap-6 mb-6">
              <Award className="text-[#ffd800] flex-shrink-0" size={36} />
              <h3 className="text-xl md:text-2xl lg:text-3xl font-bold">World Marketing Winning Awards 2023</h3>
            </div>
            
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start gap-3 md:gap-4">
                <CheckCircle className="text-[#ffd800] mt-1 flex-shrink-0" size={20} />
    ...
    {/* solution */}
      <div className="bg-darkGreen min-h-screen w-full py-12 px-4 md:py-16 md:px-8 lg:px-12 relative overflow-hidden">
      {/* Custom Cursor */}
      <div 
className={`fixed w-6 h-6 rounded-full pointer-events-none z-50 transition-all duration-75 ease-out border-2 border-[#ffd800] mix-blend-exclusion ${isPointer ? 'scale-150' : 'scale-100'}`}
        style={{ 
      ...
      />
      <div 
className={`fixed w-2 h-2 bg-[#ffd800] rounded-full pointer-events-none z-50 transition-transform duration-150 ease-out ${isPointer ? 'opacity-0' : 'opacity-100'}`}
        style={{ 
          left: `${cursorPosition.x}px`, 
          top: `${cursorPosition.y}px`,
          transform: 'translate(-50%, -50%)'
...
<div className="absolute left-0 bottom-0 w-20 h-20 rounded-full border border-[#ffd800] opacity-20"></div>
<div className="absolute right-8 bottom-40 w-32 h-32 rounded-full border border-[#ffd800] opacity-10"></div>
...
<span className="text-[#ffd800] text-sm">{service.id}</span>
          ...
          <div className="flex flex-col space-y-8">
            <p className="inline-block bg-[#1E2E2B] text-[#ffd800] px-6 py-2 rounded-md text-lg font-bold tracking-wide w-max">
              Our Solutions
            </p>
            <div>
