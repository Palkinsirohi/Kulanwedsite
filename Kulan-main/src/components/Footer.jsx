...
<div>
  ...
  >
    ...
    />
 <button className="relative w-full bg-[#FFD700] text-black font-semibold py-2 rounded-md flex items-center justify-center gap-2 overflow-hidden group shadow-md">
  ...
  <span className="absolute inset-0 z-0 bg-[#326964] translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 ease-out rounded-md" />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-300">
            <li className="flex items-center gap-2">
              <FaEnvelope className="text-[#FFD700]" /> kulan.info@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <FaPhone className="text-[#FFD700]" /> +48 93939 0239
            </li>
            <li className="flex items-center gap-2">
              <FaPhone className="text-[#FFD700]" /> +84 83939 0237
            </li>
            <li className="flex items-center gap-2">
              <FaCalendarAlt className="text-[#F7D700]" /> Mon - Fri 10:00 - 18:00
            </li>
            <li className="flex items-center gap-2">
              <FaMapMarkerAlt className="text-[#F7D700]" /> Jilons, TP06/90 NY, USA
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-600 pt-6 text-center text-sm text-gray-400">
        ...
        <span className="text-[#F7D700]">Kulan WordPress Theme</span>
      </div>
    </footer>
  );
};
